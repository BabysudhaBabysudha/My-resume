...
// import ProfessionalSkill from './resume/ProfessionalSkills';
    ...
    return (
        ...
        <div className={"cover"}>
            ...
            <div className={isDarkMode?"cover text-center mydark":'myColor cover text-center'} id='heading'>
                <h1 className='myName'>Hai<span style={{'fontSize':30}}>&#128075;</span>, This is Babysudha</h1>
        ...
        <div className={isDarkMode?'wave-bg-dark':'wave-bg'}></div>
                    ...
                    <div className='col-sm-12'>
                        ...
                        <table className={isDarkMode?'table table-dark table-striped':'table table-light table-striped'}>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>HSC</td>
                                    <td>P.K Higher Secondary School</td>
                                    <td>State Board</td>
                                    <td>2017</td>
                                    <td>74%</td>
                                </tr>
            ...
            <div className={isDarkMode?"mycolor mydark footer ":'footer myColor text-center'} id='footer'>
                <ul className='nav justify-content-center'>
                    ...
                    <li className='nav-item'>
                        <a href='https://www.instagram.com/pretty_sudha'
                        ><i className='fa fa-instagram'></i></a>
                    </li>
                   <li className='nav-item'>
                        <a href='https://wa.me/916380177670'
                        ><i className='fa fa-whatsapp'></i></a>
                    </li>
                    <li className='nav-item'>
                        <a href='mailto:p.sudha0100@gmail.com'
